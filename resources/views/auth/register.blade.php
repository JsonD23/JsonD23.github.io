...
<h1 class="text-3xl text-center font-bold" style="color: #14b8a6;">Registrarse </h1>
  ...
  <form class="mt-4" method="POST" action="">
    ...
    <button type="submit" class="rounded-md w-full text-lg
text-white font-semibold p-2 my-3 hover:bg-[#14b8a6]" style="background-color: #14b8a6;">Registrarme </button>
